(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('rxjs/Subject'), require('rxjs/operator/filter'), require('@angular/common'), require('@angular/platform-browser')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', 'rxjs/Subject', 'rxjs/operator/filter', '@angular/common', '@angular/platform-browser'], factory) :
	(factory((global.ngxModialog = global.ngxModialog || {}),global.ng.core,global.Rx,global.Rx.Observable.prototype,global.ng.common,global.ng.platformBrowser));
}(this, (function (exports,_angular_core,rxjs_Subject,rxjs_operator_filter,_angular_common,_angular_platformBrowser) { 'use strict';
...
function createComponent(instructions) {
    ...
    var /** @type {?} */ cmpFactory = injector.get(_angular_core.ComponentFactoryResolver).resolveComponentFactory(instructions.component);
...
var BaseDynamicComponent = (function () {
    ...
    BaseDynamicComponent.prototype.myAnimationEnd$ = function () {
        var _this = this;
        return rxjs_operator_filter.filter.call(this.animationEnd$, function (e) { return e.target === _this.el.nativeElement; });
    };
    /**
...
ModalOverlay.propDecorators = {
    "container": [{ type: _angular_core.ViewChild, args: ['container', { read: _angular_core.ElementRef },] },],
...
var DOMOverlayRenderer = (function () {
    ...
    DOMOverlayRenderer.prototype.render = function (dialog, vcRef, injector) {
        ...
        var /** @type {?} */ cmpRef = createComponent({
            ...
            vcRef: vcRef,
            injector: _angular_core.Injector.create([
