(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('ngx-modialog'), require('@angular/core'), require('rxjs/operator/combineLatest'), require('@angular/common')) :
	typeof define === 'function' && define.amd ? define(['exports', 'ngx-modialog', '@angular/core', 'rxjs/operator/combineLatest', '@angular/common'], factory) :
	(factory((global.ngxModialog = global.ngxModialog || {}, global.ngxModialog.bootstrap = global.ngxModialog.bootstrap || {}),global.ngxModialog,global.ng.core,global.Rx.Observable.prototype,global.ng.common));
}(this, (function (exports,ngxModialog,_angular_core,rxjs_operator_combineLatest,_angular_common) { 'use strict';
...
var BSModalContextBuilder = (function (_super) {
    ...
    function BSModalContextBuilder(defaultValues, initialSetters, baseType) {
        ...
        return _super.call(this, ngxModialog.extend(DEFAULT_VALUES, defaultValues || {}), ngxModialog.arrayUnion(DEFAULT_SETTERS, initialSetters || []), baseType || (BSModalContext // https://github.com/Microsoft/TypeScript/issues/7234
...
//# sourceMappingURL=ngx-modialog-bootstrap.umd.js.map
